    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-[4px]">
      <div className="bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md p-6 relative">
        ...
        <button
          ...
          onClick={() => setIsRequestPaymentModalOpen(false)}
        >
          <X size={24} />
        </button>
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            onClick={() => {
                localStorage.setItem("paymentMethod", "recurring");
                navigate("/recurring-one-time-payment");
            }}
          ...
          <button
            onClick={() => {
                localStorage.setItem("paymentMethod", "one-time");
                navigate("/recurring-one-time-payment");
            }}
            className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition"
          >
