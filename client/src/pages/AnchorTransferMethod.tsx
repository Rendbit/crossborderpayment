...
const AnchorTransferMethod: React.FC = () => {
  ...
  const fiatAssets = [
    {
      symbol: selectedCountryForTransfer?.symbol,
      name: selectedCountryForTransfer?.name,
      displaySymbol: selectedCountryForTransfer?.code,
    },
  ];
    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900 px-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 text-center">
          Send money to anyone across Africa without <br /> worrying about
          foreign accounts and exchange rates.
        </p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 w-full max-w-md">
          ...
          <div className="flex justify-between items-center p-4">
            ...
            <button
              onClick={() => navigate("/choose-recipient-deposit-country")}
            ...
            <div>
              ...
              >
                ...
                <p className="text-white text-[16px] text-center">
                  Your Transaction is being processed. <br /> You can monitor
                  this transaction in your transaction history
                </p>
...
export default AnchorTransferMethod;
