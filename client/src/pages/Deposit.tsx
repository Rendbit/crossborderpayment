      ...
      <div className="text-white mt-[150px] main-container md:pl-[60px] px-4 pl-2 w-full overflow-hidden md:col-span-10 col-span-12">
        <main className="top-0 md:px-[24%] px-0 left-0 right-0 w-full">
          <div className="max-w-6xl mx-auto">
            <div className="bg-whiite border border-white/10 rounded-3xl shadow-xl md:p-8 p-2 backdrop-blur-md overflow-hidden">
              <div className="text-center mb-8">
                <div className="inline-block bg-[#0E7BB2] p-3 rounded-full shadow-md">
                  <RiExchange2Line className="text-white text-xl" />
                </div>
                <h1 className="mt-4 text-2xl font-bold text-black">Manage Your Wallet</h1>
              ...
              {isActivateWalletAlert && (
                <div className="bg-red-500/80 text-black text-center text-sm py-3 px-4 rounded-md mb-6">
                  {activateWalletAlert}
                </div>
              )}
                  ...
                  <section className="w-1/2 md:px-4 px-2">
                    <div className="space-y-8">
                      <div>
                        ...
                        <div
                          className="border border-gray-300 bg-white/10 px-4 py-3 rounded-lg flex items-center justify-between cursor-pointer w-full"
                          onClick={() =>
                        ...
                        {dropDown === "assets" && (
                          <div className="absolute md:w-[47%] top-[17%] mt-2 max-h-60 overflow-y-auto bg-black rounded-lg p-3 border border-white/20 z-50 ">
                      ...
                      <div>
                        ...
                        <div className="border border-gray-300 bg-white/10 px-4 py-3 rounded-lg flex items-center justify-between">
                      ...
                      <div>
                        ...
                        <div className="bg-white/10 px-4 py-3 rounded-lg flex items-center justify-between">
                          <input
                            value={address}
                            type="text"
                            className="bg-transparent text-black w-full outline-none placeholder-gray-400"
