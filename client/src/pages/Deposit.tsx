    ...
    <div>
      <div className="flex items-start">
        ...
        <div className="w-full lg:w-[84%]  ml-auto">
          <TopNav />
          <div className="py-[20px] px-[30px] h-[100vh] mt-[70px] lg:mx-[20px] ">
            <div className="mt-5 ml-1 hidden lg:block">
              <p className="text-[32px] text-white">Deposit Crypto</p>
              ...
              <div className="flex items-center gap-5 flex-col md:flex-row">
                ...
                >
                  ...
                  <div className="mt-[12rem] mb-[52px]">
                    ...
                    <p className="mt-3 font-[300] text-[14px]">
                      Transfer crypto to your RendBit Wallet
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="mt-[12rem] mb-7">
                    ...
                    <p className="mt-3 text-[14px] font-[300]">
