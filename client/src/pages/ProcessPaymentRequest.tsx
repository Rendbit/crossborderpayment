            ...
            <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
                ...
                <div className="space-y-5">
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg">
                        <h3 className="text-sm font-semibold mb-2 text-blue-900 dark:text-blue-200">From:</h3>
                        <div className="space-y-1">
                            <p className='text-[13px] text-gray-700 dark:text-gray-300'>
                                <span className="font-medium">Username:</span> {fromUserInfo.username || 'N/A'}
                            </p>
                            <p className='text-[13px] text-gray-700 dark:text-gray-300'>
                                <span className="font-medium">Email:</span> {fromUserInfo.primaryEmail || 'N/A'}
                            </p>
                            <p className='text-[13px] text-gray-700 dark:text-gray-300'>
                                <span className="font-medium">Wallet:</span> {fromUserInfo.stellarPublicKey ? `${fromUserInfo.stellarPublicKey.slice(0, 10)}...` : 'N/A'}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg">
                        <h3 className="text-sm font-semibold mb-2 text-green-900 dark:text-green-200">To:</h3>
                        <div className="space-y-1">
                            <p className='text-[13px] text-gray-700 dark:text-gray-300'>
                                <span className="font-medium">Username:</span> {toUserInfo.username || 'N/A'}
                            </p>
                            <p className='text-[13px] text-gray-700 dark:text-gray-300'>
                                <span className="font-medium">Email:</span> {toUserInfo.primaryEmail || 'N/A'}
                            </p>
                            <p className='text-[13px] text-gray-700 dark:text-gray-300'>
                                <span className="font-medium">Wallet:</span> {toUserInfo.stellarPublicKey ? `${toUserInfo.stellarPublicKey.slice(0, 10)}...` : 'N/A'}
                            </p>
                        </div>
                    </div>
                            ...
                            <div className="pt-2 border-t border-gray-200 dark:border-gray-600">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-sm text-gray-900 dark:text-gray-100">
                                        {new Date(expirationDate).toLocaleDateString()} ({paymentRequestData.expiresIn} days)
                                    </span>
                                </div>
                            </div>
                        )}
                    ...
                    <div>
                        <label className="block text-sm font-medium mb-2">Transaction Details (Optional)</label>
                        <textarea
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-300/90 dark:bg-black/90">
                        <div className="bg-white mx-5 dark:bg-gray-800 rounded-2xl w-full max-w-lg p-6 relative">
                            ...
                            <p className="text-gray-600 dark:text-gray-300 mb-6 border-b border-gray-200 dark:border-gray-700 pb-4 md:text-[16px] text-[14px]">
                                Please enter your transaction PIN to confirm this payment of <span className="font-semibold">{paymentRequestData.amount} {paymentRequestData.currency}</span>.
                            </p>
                            ...
                            <button
                                ...
                                disabled={isLoading || !transactionPin || transactionPin.length < 4}
