          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              <div className="relative flex-1 sm:flex-none">
                ...
                />
                <input
                  className="pl-8 pr-3 py-2 border border-[#E2E4E9] dark:border-gray-700 rounded-lg text-sm w-full bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
                  placeholder="Search..."
                />
              </div>
              <button className="px-3 py-2 border border-[#E2E4E9] dark:border-gray-700 rounded-lg text-sm hover:bg-gray-50 dark:hover:bg-gray-700">
                See All
              </button>
            </div>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                <tr>
                  <td className="py-3 font-medium">Investment Return</td>
                  <td>$560.00</td>
                  <td>Checking</td>
                  <td>12 September</td>
                ...
                <tr>
                  ...
                  <td className="text-red-500">-$35.20</td>
                  <td>Ops Payroll</td>
                  <td>12 September</td>
                  <td className="flex items-center gap-1">
                    <ArrowUpRight size={14} /> Money Transfer
                  </td>
                </tr>
                <tr>
                  <td className="py-3 font-medium">Stock Dividend</td>
                  <td>$1250.00</td>
                  <td>AP</td>
                  <td>12 September</td>
                  <td className="flex items-center gap-1">
                    <Landmark size={14} /> ACH
                  </td>
                </tr>
                <tr>
                  <td className="py-3 flex items-center gap-2">
                  ...
                  <td>12 September</td>
                  <td className="flex items-center gap-1">
                    <ArrowRightLeft size={14} /> Money Transfer
                  </td>
                </tr>
              </tbody>
            </table>
