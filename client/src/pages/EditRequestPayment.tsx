    ...
    try {
      ...
      if (data.success && data.data.paymentRequest) {
        ...
        setFormData({
          ...
          toUserInput: paymentRequest.toUser?.primaryEmail || "", // Initialize with username
          ...
          <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
            ...
            <div className="space-y-5">
              ...
              {formData.status === "cancelled" && (
                <p className="text-sm text-center text-[18px] text-red-600 dark:text-red-400">
              ...
              {formData.status === "completed" && (
                <p className="text-sm text-center text-[18px] text-green-600 dark:text-green-400">
